...
Object.keys(config).forEach(function(key, val) {
	obj = config[key]
	// console.log(f.listen_check('4000', 'UDP', 'test1'))
	// f.listen_check(obj['port'], obj['protocol'], obj['name'])
	// setTimeout(() => {
	// 	console.log(f.listen_status);
...
// 	status[val] = true;
// 	f.listen_check(val['port'], val['protocol'])
// 	console.log(typeof val, val['port'], val['protocol'])
// 	// console.log(f.listen_status)
// })
